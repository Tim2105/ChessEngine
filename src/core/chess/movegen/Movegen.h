...
class Movegen {
    ...
    public:
         ...
         */
        static void generatePseudoLegalWhitePawnMoves(Array<Move, 256>& moves, const Board& board);

        /**
         * @brief Generiert alle Pseudo-Legalen Züge für die schwarzen Bauern.
         */
        static void generatePseudoLegalBlackPawnMoves(Array<Move, 256>& moves, const Board& board);

        /**
         * @brief Generiert alle Pseudo-Legalen Züge für die weißen Springer.
         */
        static void generatePseudoLegalWhiteKnightMoves(Array<Move, 256>& moves, const Board& board);

        /**
         * @brief Generiert alle Pseudo-Legalen Züge für die schwarzen Springer.
         */
        static void generatePseudoLegalBlackKnightMoves(Array<Move, 256>& moves, const Board& board);

        /**
         * @brief Generiert alle Pseudo-Legalen Züge für die weißen Läufer.
         */
        static void generatePseudoLegalWhiteBishopMoves(Array<Move, 256>& moves, const Board& board);

        /**
         * @brief Generiert alle Pseudo-Legalen Züge für die schwarzen Läufer.
         */
        static void generatePseudoLegalBlackBishopMoves(Array<Move, 256>& moves, const Board& board);

        /**
         * @brief Generiert alle Pseudo-Legalen Züge für die weißen Türme.
         */
        static void generatePseudoLegalWhiteRookMoves(Array<Move, 256>& moves, const Board& board);

        /**
         * @brief Generiert alle Pseudo-Legalen Züge für die schwarzen Türme.
         */
        static void generatePseudoLegalBlackRookMoves(Array<Move, 256>& moves, const Board& board);

        /**
         * @brief Generiert alle Pseudo-Legalen Züge für die weißen Damen.
         */
        static void generatePseudoLegalWhiteQueenMoves(Array<Move, 256>& moves, const Board& board);

        /**
         * @brief Generiert alle Pseudo-Legalen Züge für die schwarzen Damen.
         */
        static void generatePseudoLegalBlackQueenMoves(Array<Move, 256>& moves, const Board& board);

        /**
         * @brief Generiert alle Pseudo-Legalen Züge für den weißen König.
         */
        static void generatePseudoLegalWhiteKingMoves(Array<Move, 256>& moves, const Board& board);

        /**
         * @brief Generiert alle Pseudo-Legalen Züge für den schwarzen König.
         */
        static void generatePseudoLegalBlackKingMoves(Array<Move, 256>& moves, const Board& board);
         ...
         */
        static void generateWhitePawnMoves(Array<Move, 256>& moves, const Board& board,
         ...
         * @param pinnedDirections Array in 64er Notation, das für jedes Feld die Richtung angibt, in die die Figur darauf sie gefesselt ist(wenn existent).
         */
        static void generateBlackPawnMoves(Array<Move, 256>& moves, const Board& board,
                                            int32_t numAttackers, Bitboard attackingRays,
                                            Bitboard pinnedPiecesBitboard, int32_t* pinnedDirections);
         ...
         * @param pinnedPiecesBitboard Bitboard, das alle gefesselten Figuren enthält.
         */
        static void generateWhiteKnightMoves(Array<Move, 256>& moves, const Board& board,
                                                int32_t numAttackers, Bitboard attackingRays,
         ...
         * @param pinnedPiecesBitboard Bitboard, das alle gefesselten Figuren enthält.
         */
        static void generateBlackKnightMoves(Array<Move, 256>& moves, const Board& board,
                                                int32_t numAttackers, Bitboard attackingRays,
                                                Bitboard pinnedPiecesBitboard);
         ...
         * @param pinnedDirections Array in 64er Notation, das für jedes Feld die Richtung angibt, in die die Figur darauf sie gefesselt ist(wenn existent).
         */
        static void generateWhiteBishopMoves(Array<Move, 256>& moves, const Board& board,
                                                int32_t numAttackers, Bitboard attackingRays,
                                                Bitboard pinnedPiecesBitboard, int32_t* pinnedDirections);
         ...
         * @param pinnedDirections Array in 64er Notation, das für jedes Feld die Richtung angibt, in die die Figur darauf sie gefesselt ist(wenn existent).
         */
        static void generateBlackBishopMoves(Array<Move, 256>& moves, const Board& board,
                                                int32_t numAttackers, Bitboard attackingRays,
                                                Bitboard pinnedPiecesBitboard, int32_t* pinnedDirections);
         ...
         * @param pinnedDirections Array in 64er Notation, das für jedes Feld die Richtung angibt, in die die Figur darauf sie gefesselt ist(wenn existent).
         */
        static void generateWhiteRookMoves(Array<Move, 256>& moves, const Board& board,
                                            int32_t numAttackers, Bitboard attackingRays,
                                            Bitboard pinnedPiecesBitboard, int32_t* pinnedDirections);
         ...
         * @param pinnedDirections Array in 64er Notation, das für jedes Feld die Richtung angibt, in die die Figur darauf sie gefesselt ist(wenn existent).
         */
        static void generateBlackRookMoves(Array<Move, 256>& moves, const Board& board,
                                            int32_t numAttackers, Bitboard attackingRays,
                                            Bitboard pinnedPiecesBitboard, int32_t* pinnedDirections);
         ...
         * @param pinnedDirections Array in 64er Notation, das für jedes Feld die Richtung angibt, in die die Figur darauf sie gefesselt ist(wenn existent).
         */
        static void generateWhiteQueenMoves(Array<Move, 256>& moves, const Board& board,
                                            int32_t numAttackers, Bitboard attackingRays,
                                            Bitboard pinnedPiecesBitboard, int32_t* pinnedDirections);
         ...
         * @param pinnedDirections Array in 64er Notation, das für jedes Feld die Richtung angibt, in die die Figur darauf sie gefesselt ist(wenn existent).
         */
        static void generateBlackQueenMoves(Array<Move, 256>& moves, const Board& board,
                                            int32_t numAttackers, Bitboard attackingRays,
                                            Bitboard pinnedPiecesBitboard, int32_t* pinnedDirections);
         ...
         */
        static void generateWhiteKingMoves(Array<Move, 256>& moves, const Board& board, Bitboard attackedSquares);

        /**
         * @brief Generiert alle legalen Züge für den schwarzen König.
         * @param attackedSquares Bitboard, das alle Felder enthält, die die gegnerischen Figuren angreifen.
         */
        static void generateBlackKingMoves(Array<Move, 256>& moves, const Board& board, Bitboard attackedSquares);

        /**
         * @brief Generiert alle legalen Schlagzüge für die weißen Bauern.
         */
        static void generateWhitePawnCaptures(Array<Move, 256>& moves, const Board& board,
                                            int32_t numAttackers, Bitboard attackingRays,
                                            Bitboard pinnedPiecesBitboard, int32_t* pinnedDirections);
         ...
         */
        static void generateBlackPawnCaptures(Array<Move, 256>& moves, const Board& board,
                                            int32_t numAttackers, Bitboard attackingRays,
                                            Bitboard pinnedPiecesBitboard, int32_t* pinnedDirections);
         ...
         * @brief Generiert alle legalen Züge für die weißen Springer.
         */
        static void generateWhiteKnightCaptures(Array<Move, 256>& moves, const Board& board,
                                                int32_t numAttackers, Bitboard attackingRays,
                                                Bitboard pinnedPiecesBitboard);
         ...
         * @brief Generiert alle legalen Züge für die schwarzen Springer.
         */
        static void generateBlackKnightCaptures(Array<Move, 256>& moves, const Board& board,
                                                int32_t numAttackers, Bitboard attackingRays,
                                                Bitboard pinnedPiecesBitboard);
         ...
         * @brief Generiert alle legalen Züge für die weißen Läufer.
         */
        static void generateWhiteBishopCaptures(Array<Move, 256>& moves, const Board& board,
                                                int32_t numAttackers, Bitboard attackingRays,
                                                Bitboard pinnedPiecesBitboard, int32_t* pinnedDirections);
         ...
         * @brief Generiert alle legalen Züge für die schwarzen Läufer.
         */
        static void generateBlackBishopCaptures(Array<Move, 256>& moves, const Board& board,
                                                int32_t numAttackers, Bitboard attackingRays,
                                                Bitboard pinnedPiecesBitboard, int32_t* pinnedDirections);
         ...
         * @brief Generiert alle legalen Züge für die weißen Türme.
         */
        static void generateWhiteRookCaptures(Array<Move, 256>& moves, const Board& board,
                                                int32_t numAttackers, Bitboard attackingRays,
                                                Bitboard pinnedPiecesBitboard, int32_t* pinnedDirections);
         ...
         * @brief Generiert alle legalen Züge für die schwarzen Türme.
         */
        static void generateBlackRookCaptures(Array<Move, 256>& moves, const Board& board,
                                                int32_t numAttackers, Bitboard attackingRays,
                                                Bitboard pinnedPiecesBitboard, int32_t* pinnedDirections);
         ...
         * @brief Generiert alle legalen Züge für die weißen Damen.
         */
        static void generateWhiteQueenCaptures(Array<Move, 256>& moves, const Board& board,
                                                int32_t numAttackers, Bitboard attackingRays,
                                                Bitboard pinnedPiecesBitboard, int32_t* pinnedDirections);
         ...
         * @brief Generiert alle legalen Züge für die schwarzen Damen.
         */
        static void generateBlackQueenCaptures(Array<Move, 256>& moves, const Board& board, 
                                                int32_t numAttackers, Bitboard attackingRays,
                                                Bitboard pinnedPiecesBitboard, int32_t* pinnedDirections);
         ...
         * @brief Generiert alle legalen Züge für den weißen König.
         */
        static void generateWhiteKingCaptures(Array<Move, 256>& moves, const Board& board);

        /**
         * @brief Generiert alle legalen Züge für den schwarzen König.
         */
        static void generateBlackKingCaptures(Array<Move, 256>& moves, const Board& board);
