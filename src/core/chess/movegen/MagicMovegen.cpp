...
void MagicMovegen::generatePseudoLegalWhiteKingMoves(Array<Move, 256>& moves, Board& b) {
...
void MagicMovegen::generatePseudoLegalBlackKingMoves(Array<Move, 256>& moves, Board& b) {
...
// void MagicMovegen::generateWhitePawnMoves(Array<Move, 256>& moves, Board& b,
...
// void MagicMovegen::generateBlackPawnMoves(Array<Move, 256>& moves, Board& b,
//                                      int32_t numAttackers, Bitboard attackingRays,
//                                      Bitboard pinnedPiecesBitboard, int32_t* pinDirections) {
...
// void MagicMovegen::generateWhiteKnightMoves(Array<Move, 256>& moves, Board& b,
//                                        int32_t numAttackers, Bitboard attackingRays,
...
// void MagicMovegen::generateBlackKnightMoves(Array<Move, 256>& moves, Board& b,
//                                        int32_t numAttackers, Bitboard attackingRays,
//                                        Bitboard pinnedPieces) {
//     // Wenn der eigene König von mehr als einer Figur angegriffen wird, muss er sich bewegen
//     // -> Kein Springerzug kann legal sein
...
// void MagicMovegen::generateWhiteBishopMoves(Array<Move, 256>& moves, Board& b,
//                                        int32_t numAttackers, Bitboard attackingRays,
//                                        Bitboard pinnedPiecesBitboard, int32_t* pinDirections) {
//     // Wenn der eigene König von mehr als einer Figur angegriffen wird, muss er sich bewegen
...
// void MagicMovegen::generateBlackBishopMoves(Array<Move, 256>& moves, Board& b,
//                                        int32_t numAttackers, Bitboard attackingRays,
//                                        Bitboard pinnedPiecesBitboard, int32_t* pinDirections) {
//     // Wenn der eigene König von mehr als einer Figur angegriffen wird, muss er sich bewegen
//     // -> Kein Läuferzug kann legal sein
...
// void MagicMovegen::generateWhiteRookMoves(Array<Move, 256>& moves, Board& b,
//                                      int32_t numAttackers, Bitboard attackingRays,
//                                      Bitboard pinnedPiecesBitboard, int32_t* pinDirections) {
//     // Wenn der eigene König von mehr als einer Figur angegriffen wird, muss er sich bewegen
...
// void MagicMovegen::generateBlackRookMoves(Array<Move, 256>& moves, Board& b,
//                                      int32_t numAttackers, Bitboard attackingRays,
//                                      Bitboard pinnedPiecesBitboard, int32_t* pinDirections) {
//     // Wenn der eigene König von mehr als einer Figur angegriffen wird, muss er sich bewegen
//     // -> Kein Turmzug kann legal sein
...
// void MagicMovegen::generateWhiteQueenMoves(Array<Move, 256>& moves, Board& b,
//                                       int32_t numAttackers, Bitboard attackingRays,
//                                       Bitboard pinnedPiecesBitboard, int32_t* pinDirections) {
//     // Wenn der eigene König von mehr als einer Figur angegriffen wird, muss er sich bewegen
...
// void MagicMovegen::generateBlackQueenMoves(Array<Move, 256>& moves, Board& b,
//                                       int32_t numAttackers, Bitboard attackingRays,
//                                       Bitboard pinnedPiecesBitboard, int32_t* pinDirections) {
//     // Wenn der eigene König von mehr als einer Figur angegriffen wird, muss er sich bewegen
//     // -> Kein Damenzug kann legal sein
...
// void MagicMovegen::generateWhiteKingMoves(Array<Move, 256>& moves, Board& b,
...
// void MagicMovegen::generateBlackKingMoves(Array<Move, 256>& moves, Board& b,
//                                      Bitboard attackedSquares) {
//     int32_t KING_ATTACKS[8] = {
//         DIAGONAL_ATTACKS[0], DIAGONAL_ATTACKS[1], DIAGONAL_ATTACKS[2], DIAGONAL_ATTACKS[3],
//         STRAIGHT_ATTACKS[0], STRAIGHT_ATTACKS[1], STRAIGHT_ATTACKS[2], STRAIGHT_ATTACKS[3]
...
// void MagicMovegen::generateWhitePawnCaptures(Array<Move, 256>& moves, Board& b,
//                                      int32_t numAttackers, Bitboard attackingRays,
//                                      Bitboard pinnedPiecesBitboard, int32_t* pinDirections) {
//     // Wenn der eigene König von mehr als einer Figur angegriffen wird, muss er sich bewegen
//     // -> Kein Bauernzug kann legal sein
...
// void MagicMovegen::generateBlackPawnCaptures(Array<Move, 256>& moves, Board& b,
//                                      int32_t numAttackers, Bitboard attackingRays,
//                                      Bitboard pinnedPiecesBitboard, int32_t* pinDirections) {
...
// void MagicMovegen::generateWhiteKnightCaptures(Array<Move, 256>& moves, Board& b,
//                                        int32_t numAttackers, Bitboard attackingRays,
//                                        Bitboard pinnedPieces) {
//     // Wenn der eigene König von mehr als einer Figur angegriffen wird, muss er sich bewegen
//     // -> Kein Springerzug kann legal sein
...
// void MagicMovegen::generateBlackKnightCaptures(Array<Move, 256>& moves, Board& b,
//                                        int32_t numAttackers, Bitboard attackingRays,
//                                        Bitboard pinnedPieces) {
...
// void MagicMovegen::generateWhiteBishopCaptures(Array<Move, 256>& moves, Board& b,
//                                        int32_t numAttackers, Bitboard attackingRays,
//                                        Bitboard pinnedPiecesBitboard, int32_t* pinDirections) {
//     // Wenn der eigene König von mehr als einer Figur angegriffen wird, muss er sich bewegen
//     // -> Kein Läuferzug kann legal sein
...
// void MagicMovegen::generateBlackBishopCaptures(Array<Move, 256>& moves, Board& b,
//                                        int32_t numAttackers, Bitboard attackingRays,
//                                        Bitboard pinnedPiecesBitboard, int32_t* pinDirections) {
//     // Wenn der eigene König von mehr als einer Figur angegriffen wird, muss er sich bewegen
//     // -> Kein Läuferzug kann legal sein
...
// void MagicMovegen::generateWhiteRookCaptures(Array<Move, 256>& moves, Board& b,
//                                      int32_t numAttackers, Bitboard attackingRays,
//                                      Bitboard pinnedPiecesBitboard, int32_t* pinDirections) {
//     // Wenn der eigene König von mehr als einer Figur angegriffen wird, muss er sich bewegen
//     // -> Kein Turmzug kann legal sein
...
// void MagicMovegen::generateBlackRookCaptures(Array<Move, 256>& moves, Board& b,
//                                      int32_t numAttackers, Bitboard attackingRays,
//                                      Bitboard pinnedPiecesBitboard, int32_t* pinDirections) {
//     // Wenn der eigene König von mehr als einer Figur angegriffen wird, muss er sich bewegen
//     // -> Kein Turmzug kann legal sein
...
// void MagicMovegen::generateWhiteQueenCaptures(Array<Move, 256>& moves, Board& b,
//                                      int32_t numAttackers, Bitboard attackingRays,
//                                      Bitboard pinnedPiecesBitboard, int32_t* pinDirections) {
//     // Wenn der eigene König von mehr als einer Figur angegriffen wird, muss er sich bewegen
//     // -> Kein Läuferzug kann legal sein
...
// void MagicMovegen::generateBlackQueenCaptures(Array<Move, 256>& moves, Board& b,
//                                      int32_t numAttackers, Bitboard attackingRays,
//                                      Bitboard pinnedPiecesBitboard, int32_t* pinDirections) {
//     // Wenn der eigene König von mehr als einer Figur angegriffen wird, muss er sich bewegen
//     // -> Kein Läuferzug kann legal sein
...
// void MagicMovegen::generateWhiteKingCaptures(Array<Move, 256>& moves, Board& b,
//                                         Bitboard attackedSquares) {
//     int32_t KING_ATTACKS[8] = {
//         DIAGONAL_ATTACKS[0], DIAGONAL_ATTACKS[1], DIAGONAL_ATTACKS[2], DIAGONAL_ATTACKS[3],
//         STRAIGHT_ATTACKS[0], STRAIGHT_ATTACKS[1], STRAIGHT_ATTACKS[2], STRAIGHT_ATTACKS[3]
...
// void MagicMovegen::generateBlackKingCaptures(Array<Move, 256>& moves, Board& b,
//                                         Bitboard attackedSquares) {
//     int32_t KING_ATTACKS[8] = {
//         DIAGONAL_ATTACKS[0], DIAGONAL_ATTACKS[1], DIAGONAL_ATTACKS[2], DIAGONAL_ATTACKS[3],
//         STRAIGHT_ATTACKS[0], STRAIGHT_ATTACKS[1], STRAIGHT_ATTACKS[2], STRAIGHT_ATTACKS[3]
