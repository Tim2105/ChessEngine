...
Variable numEpochs("numEpochs", "Number of epochs for training at generation 0", 8ull);
...
Variable eloAddPeriod("eloAddPeriod", "Add a new generation snapshot to Elo table every N generations", 10ull);
Variable eloUpdatePeriod("eloUpdatePeriod", "Update Elo table every N generations", 5ull);
Variable eloNumGamesPerUpdate("eloNumGamesPerUpdate", "Number of games to play when updating the Elo table", 200ull);
