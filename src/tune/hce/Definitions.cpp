...
Variable timeControl("timeControl", "Time control in ms at generation 0", 800ull);
Variable increment("increment", "Time control increment in ms at generation 0", 80ull);
Variable timeGrowth("timeGrowth", "Time control growth factor with each generation", 1.02);
...
Variable noiseDecay("noiseDecay", "Noise decay factor with each generation", 0.95);
...
Variable learningRateDecay("learningRateDecay", "Learning rate decay factor with each generation", 0.995);
...
Variable numGenerations("numGenerations", "Number of generations for training", 500ull);
...
Variable batchSize("batchSize", "Batch size for training", 256ull);
