...
Variable timeControl("timeControl", "Time control in ms at generation 0", 10000ull);
Variable increment("increment", "Time control increment in ms at generation 0", 1000ull);
...
Variable noiseDefaultStdDev("noiseDefaultStdDev", "Default standard deviation for noise", 0.8);
Variable noiseLinearStdDev("noiseLinearStdDev", "Additional standard deviation for noise based on the absolute value of the parameter", 0.04);
Variable noiseDecay("noiseDecay", "Noise decay factor with each generation", 0.992);
...
Variable learningRateDecay("learningRateDecay", "Learning rate decay factor with each generation", 0.996);
