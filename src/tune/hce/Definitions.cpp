...
Variable timeControl("timeControl", "Time control in ms at generation 0", 20000ull);
Variable increment("increment", "Time control increment in ms at generation 0", 2000ull);
...
Variable learningRate("learningRate", "Learning rate for the optimizer at generation 0", 0.08);
